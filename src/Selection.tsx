    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "10px", margin: "20px 0" }}>
                {["album", "single", "compilation"].map((type) => {
                    const albumsByType = renderAlbumsByType(selectedAlbums, type);
                    if (!albumsByType || albumsByType.length === 0) return null; // Skip rendering if no albums of this type
                    return (
